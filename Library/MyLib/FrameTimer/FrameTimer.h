...
namespace MyLib
{
	...
	public:
		 ...
		 * @param なし
		 */
		FrameTimer(const LONGLONG& currentTime);
		 ...
		 */
		FrameTimer(int fps, const LONGLONG& currentTime);
	...
	public:
		 ...
		 * @return なし
		 */
		void Reset(const LONGLONG& currentTime);
		 ...
		 * @return なし
		 */
		void Update(const LONGLONG& currentTime);
