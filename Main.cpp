...
LPCWSTR g_szAppName = L"NocThread";
   ...
   // フルスクリーンにするかどうか
    ...
    // Register class and create window
    {
        ...
        HWND hwnd = CreateWindowExW(0, L"_3DPrograming_GFWindowClass", g_szAppName, WS_MYWINDOW,
            ...
            g_game.get());
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"_3DPrograming_GFWindowClass", g_szAppName, WS_POPUP,
        ...
        // 追加
        if (s_fullscreen) g_game->RequestFullscreenState(TRUE);
