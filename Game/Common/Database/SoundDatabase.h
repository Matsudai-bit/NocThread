...
namespace SoundDatabase
{
	...
	static const std::string SE_PAUSE_OPEN 			    = "SE/se_ui_pause_open.wav";
	...
	static const std::string SE_PLAYER_STEPPING		= "SE/se_player_stepping.wav";
	...
	static const std::unordered_map<std::string, SoundManager::SoundClip> SOUND_CLIP_MAP =
	{
		...
		{ SE_PAUSE_OPEN,				{ SoundManager::SoundType::SE, SE_PAUSE_OPEN, 0.7f }},
		...
		{ SE_PLAYER_STEPPING,		{ SoundManager::SoundType::SE, SE_PLAYER_STEPPING, 0.7f }},
