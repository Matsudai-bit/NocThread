 ...
 */
void InputManager::AddActionMap(std::unique_ptr<InputActionMap> inputActionMap)
{
 ...
 */
void InputManager::CheckInputActionMap(InputActionMap* pInputActionMap)
{
	// マップデータのデータ毎に処理する
 ...
 */
bool InputManager::CheckInputData(const InputData& inputData, InputOptionData* pOption)
{
	// 結果
	bool result = false;
 ...
 * @returns false  入力されていない
 */
bool InputManager::CheckInputKeyboard(const InputData& inputData, InputOptionData* pInputOption)
{
	bool result = true;
 ...
 * @returns false  入力されていない
 */
bool InputManager::CheckInputMouse(const InputData& inputData, InputOptionData* pInputOption)
{
 ...
 * @returns false  入力されていない
 */
bool InputManager::CheckInputGamePad(const InputData& inputData, InputOptionData* pInputOption)
{
	using namespace DirectX;
