 ...
 * @brief   リザルトシーンの成功状態に関するヘッダーファイル
 *
 * @author  松下大暉
 * @date    2025/09/15
 *********************************************************************/
 ...
 * @brief リザルトシーンの成功状態
 */
class SuccessResultState : public StateBase<ResultScene>
{
	// クラス定数の宣言 -------------------------------------------------
public:
...
private:
	...
	std::unique_ptr<Sprite> m_successFontSprite;	///< 成功の文字スプライト
	std::unique_ptr<Sprite> m_resultFontSprite;		///< リザルトの文字スプライト
	std::unique_ptr<Sprite> m_clearTimeFontSprite;	///< クリア時間の文字スプライト
